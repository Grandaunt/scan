...
public class mRecyclerView extends RecyclerView {
    ...
    private void init() {
        ...
        MXRLoadingMoreFooter footView = new MXRLoadingMoreFooter(getContext());
    ...
    public void loadMoreComplete() {
        isLoadingData = false;
        if (mFootView instanceof MXRLoadingMoreFooter) {
            ((MXRLoadingMoreFooter) mFootView).setState(MXRLoadingMoreFooter.STATE_COMPLETE);
        } else {
    ...
    public void setNoMore(boolean noMore){
        ...
        isNoMore = noMore;
        if (mFootView instanceof MXRLoadingMoreFooter) {
            ((MXRLoadingMoreFooter) mFootView).setState(isNoMore ? MXRLoadingMoreFooter.STATE_NOMORE:MXRLoadingMoreFooter.STATE_COMPLETE);
        } else {
            mFootView.setVisibility(View.GONE);
        }
    }
    ...
    public void setLoadingMoreProgressStyle(int style) {
        ...
        if (mFootView instanceof MXRLoadingMoreFooter) {
            ((MXRLoadingMoreFooter) mFootView).setProgressStyle(style);
        }
    }
    ...
    public void onScrollStateChanged(int state) {
        ...
        if (state == RecyclerView.SCROLL_STATE_IDLE && mLoadingListener != null && !isLoadingData && loadingMoreEnabled) {
            ...
            if (layoutManager.getChildCount() > 0
                ...
                isLoadingData = true;
                if (mFootView instanceof MXRLoadingMoreFooter) {
                    ((MXRLoadingMoreFooter) mFootView).setState(MXRLoadingMoreFooter.STATE_LOADING);
                } else {
