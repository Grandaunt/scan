 ...
 * -list03
 */
public class DialogBottomCustPicker {
    ...
    public DialogBottomCustPicker(Context context, ResultString ResultString) {
    ...
    public DialogBottomCustPicker initData(List<String> year, List<List<String>> monthAll) {
    ...
    public DialogBottomCustPicker SetTitle(String title, String leftStr, String rightStr){
        tv_title.setText(title);
        tv_cancle.setText(leftStr);
        tv_select.setText(rightStr);
        return this;
    }
     ...
     * 设置日期控件是否可以循环滚动
     */
    public DialogBottomCustPicker setIsLoop(boolean isLoop) {
